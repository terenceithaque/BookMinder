...
class Application(Tk):
    ...
    def __init__(self):
        ...
        self.menu_lecture.add_command(label="Nouvelle lecture...", command=None) # On ajoute une commande qui permet d'ajouter un livre dans les lectures au menu lecture
